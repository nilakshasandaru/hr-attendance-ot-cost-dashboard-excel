...
1. Open `Attendance_Data` and go to the next empty row
2. Fill in **Date, Employee_ID, Status** (from the dropdown), **In_Time, Out_Time**
3. Worked_Hours, OT_Hours, and OT_Cost calculate automatically
4. The Dashboard (KPIs, tables, charts) updates the moment the workbook recalculates
